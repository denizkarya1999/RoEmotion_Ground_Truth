"""Application launcher for the breathing signal monitor.
...
def main() -> None:
    ...
    from gui import BreathingSignalGUI

    root = tk.Tk()

    # Basic window settings keep the app usable on both small and large screens.
    root.title("Breath-based Signal Monitor")
    root.geometry("860x620")
    root.minsize(720, 540)

    gui = BreathingSignalGUI(root)
